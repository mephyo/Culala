                ...
                <tr v-for="a in appliers" :key="a._id">
                    <td>
                        <div class="cell-inline">
                            <span>{{a.call}}</span>
                            <template v-if="a.age">
                                <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.gender==='female'">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.gender==='male'">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.gender==='futa'">
                    ...
                    <td>
                        <div class="cell-inline">
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.place.includes('outdoor')">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.place.includes('public')">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.place.includes('hotel')">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.place.includes('home')">
                                <path d="M8,20H5V12H2L12,3L22,12H19V20H12V14H8V20M14,14V17H17V14H14Z" />
                            </svg>
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.place.includes('other')">
                    ...
                    <td>
                        <div class="cell-inline" v-if="a.time">
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.time.includes('dawn')">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.time.includes('morning')">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.time.includes('afternoon')">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.time.includes('evening')">
                    ...
                    <td>
                        <div class="cell-inline">
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.style==='myIdea'">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.style==='yourIdea'">
                    ...
                    <td>
                        <div class="cell-inline">
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.cloth.includes('nude')">
                                <path d="M12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3C19.58,3 22,5.41 22,8.5C22,12.27 18.6,15.36 13.45,20.03L12,21.35Z" />
                            </svg>
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.cloth.includes('underwear')">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.cloth.includes('casual')">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.cloth.includes('other')">
                                <path d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                    ...
                    <td>
                        <div class="cell-inline">
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.emotion==='excellent'">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.emotion==='good'">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.emotion==='poor'">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.emotion==='none'">
                    ...
                    <td>
                        <div class="cell-inline">
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.pose==='excellent'">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.pose==='good'">
                                <path d="M21,9H15V22H13V16H11V22H9V9H3V7H21M12,2A2,2 0 0,1 14,4A2,2 0 0,1 12,6C10.89,6 10,5.1 10,4C10,2.89 10.89,2 12,2Z" />
                            </svg>
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="a.pose==='poor'">
