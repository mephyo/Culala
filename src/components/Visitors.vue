                ...
                <tr v-for="v in visitors" :key="v._id">
                    <td>
                        <div class="cell-inline">
                            ...
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="v.viewTimes==='1'">
                    ...
                    <td>
                        <div class="cell-inline">
                            <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="v.lastLocation==='Not Applied.'">
                    ...
                    <td :title="v.model.ua">
                        <div class="cell-inline">
                            <template>
                                <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="v.model.os.name==='iOS'">
                                ...
                                <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-else-if="v.model.os.name==='Android'">
                                ...
                                <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-else-if="v.model.os.name==='Mac OS'">
                                ...
                                <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-else-if="v.model.os.name==='Windows'">
                            ...
                            <template>
                                ...
                                <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-else-if="v.model.browser.name==='Safari' || v.model.browser.name==='Mobile Safari'">
                                ...
                                <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-else-if="v.model.browser.name==='WeChat'">
                                ...
                                <template v-else>
                                    <svg class="naked-icon-black" style="width:24px;height:24px" viewBox="0 0 24 24" v-if="v.model.ua.includes('douban')">
