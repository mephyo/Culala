                ...
                <tr v-for="v in visitors" :key="v._id">
                    <td>
                        <div class="cell-inline">
                            ...
                            <svg class="naked-icon-black" viewBox="0 0 24 24" v-if="v.viewTimes==='1'">
                    ...
                    <td>
                        <div class="cell-inline">
                            <svg class="naked-icon-black" viewBox="0 0 24 24" v-if="v.lastLocation==='Not Applied.'">
                    ...
                    <td :title="v.model.ua">
                        <div class="cell-inline">
                            <template>
                                <svg class="naked-icon-black" viewBox="0 0 24 24" v-if="v.model.os.name==='iOS'">
                                ...
                                <svg class="naked-icon-black" viewBox="0 0 24 24" v-else-if="v.model.os.name==='Android'">
                                ...
                                <svg class="naked-icon-black" viewBox="0 0 24 24" v-else-if="v.model.os.name==='Mac OS'">
                                ...
                                <svg class="naked-icon-black" viewBox="0 0 24 24" v-else-if="v.model.os.name==='Windows'">
                                    <path d="M3,12V6.75L9,5.43V11.91L3,12M20,3V11.75L10,11.9V5.21L20,3M3,13L9,13.09V19.9L3,18.75V13M20,13.25V22L10,20.09V13.1L20,13.25Z" />
                                </svg>
                                <svg class="naked-icon-black" viewBox="0 0 24 24" v-else-if="v.model.ua.includes('Googlebot')">
                            ...
                            <template>
                                <svg class="naked-icon-black" viewBox="0 0 24 24" v-if="v.model.browser.name==='Chrome'">
                                ...
                                <svg class="naked-icon-black" viewBox="0 0 24 24" v-else-if="v.model.browser.name==='Safari' || v.model.browser.name==='Mobile Safari'">
                                ...
                                <svg class="naked-icon-black" viewBox="0 0 24 24" v-else-if="v.model.browser.name==='WeChat'">
                                ...
                                <template v-else>
                                    <svg class="naked-icon-black" viewBox="0 0 24 24" v-if="v.model.ua.includes('douban')">
                                    ...
                                    <svg class="naked-icon-black" viewBox="0 0 24 24" v-else-if="v.model.ua.includes('BingPreview')">
